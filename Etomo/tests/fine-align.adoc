...
#values
assert.tf.ratio-of-measurements-to-unknowns-to-achieve=%{ratio-of-measurements-to-unknowns-to-achieve}
assert.tf.minimum=3.2
#enabled
...
#behavior
assert.rb.solve-for-all-magnifications=on
tf.ratio-of-measurements-to-unknowns-to-achieve=8.8
tf.minimum=8.7
bn.restrict-variables=
wait.process.reloading-align=done
#test orderOfRestrictions from user template
assert.rb.fixed-magnifications-at-10=on
rb.solve-for-all-magnifications=
tf.ratio-of-measurements-to-unknowns-to-achieve=%{ratio-of-measurements-to-unknowns-to-achieve}
tf.minimum=3.2
