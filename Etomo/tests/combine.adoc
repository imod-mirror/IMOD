...
[[if = test-gui]]
  ...
  assert.tf.limit-on-residual-in-patch-correlations=10.0
  #
  ...
  #
  #dualvolmatch parameters
  assert.disabled.tf.limit-on-residual-in-patch-correlations=
  #
  ...
  #
  #dualvolmatch parameters
  assert.enabled.tf.limit-on-residual-in-patch-correlations=
  cb.use-image-correlations-instead-of-solvematch-for-initial-match=off
  #
  #solvematch parameters
  assert.enabled.cb.load-binned-by-2=
