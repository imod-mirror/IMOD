...
[[if = test-gui]]
  ...
  if.not.var.patch-tracking.assert.cb.use-image-correlations-instead-of-solvematch-for-initial-match=off
  if.var.patch-tracking.assert.cb.use-image-correlations-instead-of-solvematch-for-initial-match=on
  #
  ...
  if.var.patch-tracking.assert.enabled.rb.use-matching-models-only=
  ...
  if.var.patch-tracking.cb.use-image-correlations-instead-of-solvematch-for-initial-match=on
  #
  #solvematch parameters
