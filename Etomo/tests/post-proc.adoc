...
#check values
assert.tf.x-min=1
if.not.var.patch-tracking.assert.tf.x-max=%{size-to-output-x}
if.var.patch-tracking.assert.tf.x-max=%{size-to-output-x-patch-tracking}
assert.tf.y-min=1
if.not.var.patch-tracking.assert.tf.y-max=%{size-to-output-y}
if.var.patch-tracking.assert.tf.y-max=%{size-to-output-y-patch-tracking}
assert.tf.z-min=1
[[if = patch-tracking]]
...
[[if = patch-tracking]]
  if.not.var.zero-bead.assert.tf.z-min.1=%{scaling-z-min-patch-tracking}
  if.var.zero-bead.assert.tf.z-min.1=%{scaling-z-min-patch-tracking-zero-bead}
  if.not.var.zero-bead.assert.tf.z-max.1=%{scaling-z-max-patch-tracking}
  if.var.zero-bead.assert.tf.z-max.1=%{scaling-z-max-patch-tracking-zero-bead}
[[]]
[[ifnot = patch-tracking]]
