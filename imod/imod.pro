SOURCES	+= autox.c b3dfile.c b3dgfx.c control.c imod_cachefill.c imod_client_message.c imod_cont_copy.c imod_cont_edit.c imod_display.cpp imod_edit.c imod_info.c imod_info_cb.c imod_input.cpp imod_io.c imod_iscale.c imod_menu.cpp imod_model_draw.c imod_model_edit.c imod_moviecon.c imodplug.c imodv_depthcue.c imodv_gfx.c imodview.c imodv_image.c imodv_input.c imodv_light.c imodv_menu.c imodv_modeled.c imodv_movie.c imodv_objed.c imodv_ogl.c imodv_stereo.c imodv_views.c imod_workprocs.c iproc.c pixelview.c samplemeansd.c sliceproc.c slicer.c wprint.c xgraph.c ximodv.c xtilt.c xtum.c xyz.cpp xzap.cpp imod.cpp imod_object_edit.cpp imodv_control.cpp imodv.cpp zap_classes.cpp arrowbutton.cpp tooledit.cpp

HEADERS	+= autox.h b3dgfx.h hotkey.h imod_client_message.h imod.h imod_info.h imod_input.h imod_io.h imodP.h imodv.h iproc.h keypad.h menus.h options.h sliceproc.h slicer.h sslice.h xxyz.h xzap.h imod_object_edit.h imodv_control.h zap_classes.h imod_display.h arrowbutton.h tooledit.h qcursor.bits qcursor_mask.bits time_lock.bits unlock.bits lock.bits
