...
/*  $Author$
    ...
    $Log$
    Revision 1.2  2005/03/09 21:18:48  mast
    Rewrote code to eliminate redundant code in edge cases and removed parallel
    processor sections; simplified some expressions; experimented with gradient
